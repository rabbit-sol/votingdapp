...
<ul>
    <li><a href="https://nodejs.org/en/download/" rel="nofollow">Nodejs</a></li>
...
<div class="snippet-clipboard-content position-relative"><pre style="position: relative;"><code>npm install -g truffle@5.0.2
npm install
